...
<head>
    ...
    <link href="style/Nars.css" media="screen" rel="stylesheet" content="text/css">
</head>
<body>
<div class="navbar">
...
<div id="products" class="container">
    <div class="products">
        <div class="product">
            <img src="images/nars1.jpg" alt="Palette 1">
            <h3>NARS Skin Deep Pallete</h3>
            <p>A versatile eyeshadow pallete with 12 neutral shades for various looks.</p>
            <div class="price">₱390.00</div>
            <button>Add to Cart</button>
        </div>
        <div class="product">
            <img src="images/nars3.jpg" alt="Palette 1">
            <h3>NARS Eyeshadow Palette Extreme Effects</h3>
            <p>Limited edition cllection of 12 eyeshadow shades known for their high pigmentation, smooth texxture, andd variety of finishes.</p>
            <div class="price">₱250.00</div>
            <button>Add to Cart</button>
        </div>
        <div class="product">
            <img src="images/nars8.jpg" alt="Contour 1">
            <h3>NARS Contour Stick</h3>
            <p>This countor stick is available in multiple shades, and it can be used to contour and highlight the face.</p>
        ...
        <div class="product">
            <img src="images/nars7.jpg" alt="Makeup Brush 4">
            <h3>NARS Mini Blush</h3>
            <p>A compact version of NARS' iconic blush, delivering buildable, natural-looking color with a silky, blendable formula perfect for on-the-go touch-ups.</p>
